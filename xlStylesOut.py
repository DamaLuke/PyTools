...
class xlStyleFormat:
    def __init__(self, path, dfs, headers = None):
        ...
        self.title_font = Font(name="MYingHei_18030_C-Medium", size=10, bold=True, color="00FFFFFF")
        self.title_fill = PatternFill(fill_type="solid", start_color="3D5AAE", end_color="3D5AAE")
        self.body_font = Font(name="MYingHei_18030_C-Medium", size=9, bold=False, color="000000")
        self.body_fill = PatternFill(fill_type="solid", start_color="00FFFFFF", end_color="00FFFFFF")
